...
def upgrade() -> None:
    _pk_table(
        ...
        sa.Column(
            "discreet_mode", sa.Boolean(), nullable=False, server_default=sa.false()
        ),
        sa.Column(
        ...
        sa.Column(
            "auto_lock_minutes", sa.Integer(), nullable=False, server_default="5"
        ),
        sa.Column(
            "locale", sa.String(length=12), nullable=False, server_default="pt-BR"
        ),
    ...
    _pk_table(
        ...
        sa.Column(
            "emergency_checklist", sa.JSON(), nullable=False, server_default="[]"
        ),
    )
    _pk_table(
        "trusted_contacts",
    ...
    _pk_table(
        ...
        sa.Column(
            "quick_exit_enabled", sa.Boolean(), nullable=False, server_default=sa.true()
        ),
        sa.Column(
            "notifications_hidden",
            sa.Boolean(),
        ...
        sa.Column(
            ...
            nullable=False,
            server_default="Acolhe",
        ),
        sa.Column(
            "notification_title",
            sa.String(length=120),
            nullable=False,
            server_default="Nova atualizacao",
        ),
        sa.Column(
